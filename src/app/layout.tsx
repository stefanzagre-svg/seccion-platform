...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const organizationSchema = {
    ...
    "@type": "Organization",
    "name": "SECCION",
    "alternateName": ["SECCION.ai", "seccion.ai", "Seccion", "SECCION AI Hybrid Platform", "SECCION Dating & Live Streaming"],
    "url": "https://seccion.ai",
    "logo": "https://seccion.ai/assets/logo/logo-wordmark.png",
    "description": "SECCION is the 1st hybrid platform combining AI-driven dating matchmaking with a live streaming creator economy. Creators keep 90% revenue.",
    "foundingDate": "2025",
    "areaServed": ["CO", "ES", "US"],
  ...
  const websiteSchema = {
    "@context": "https://schema.org",
    "@type": "WebSite",
    "name": "SECCION.ai - 1st AI Dating & Creator Live Streaming Hybrid Platform",
    "alternateName": "SECCION AI Hybrid Platform",
    "url": "https://seccion.ai",
