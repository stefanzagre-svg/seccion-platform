...
export default function BecomeCreatorPage() {
  ...
  return (
    ...
    >
      <title>{t("seo.becomeCreator.title")}</title>
      <meta name="description" content={t("seo.becomeCreator.desc")} />
      ...
      <section id="apply" className="relative z-10 py-24 px-4 sm:px-6 md:px-12 lg:px-20 max-w-[1440px] mx-auto w-full border-t border-white/5">
        <div className="max-w-[720px] mx-auto space-y-12">
          ...
          <div className="text-center space-y-3">
            <span className="text-[10px] font-mono font-bold text-[#ffabf3] bg-[#ffabf3]/5 border border-[#ffabf3]/25 px-3 py-1 rounded-full uppercase tracking-wider">
              {locale === "es" ? "Únete como Creador" : "Enlist as Creator"}
            </span>
            <h2 className="font-display text-3xl md:text-5xl font-black text-white tracking-tight">
              {locale === "es" ? "Solicita tu Acceso de Creador" : "Request Your Creator Access"}
            </h2>
            <p className="max-w-[500px] mx-auto text-xs sm:text-sm text-[#b9cac9] leading-relaxed font-medium">
              {locale === "es"
                ? "Revisamos cada creador manualmente para mantener los más altos estándares de vibe. Comparte tus perfiles, reclama tu año gratis y preparemos tu espacio."
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2 text-left md:col-span-2">
                        <label className="text-[10px] font-mono uppercase text-[#b9cac9] tracking-wider block">{locale === "es" ? "Nombre Completo / Nombre de Creador" : "Full Name / Creator Name"}</label>
                        <div className="relative">
                          ...
                          <input 
                            ...
                            placeholder={locale === "es" ? "ej. Siena Vibe o Sarah Jenkins" : "e.g. Siena Vibe or Sarah Jenkins"}
                      ...
                      <div className="space-y-2 text-left">
                        <label className="text-[10px] font-mono uppercase text-[#b9cac9] tracking-wider block">{locale === "es" ? "Email Principal" : "Primary Email"}</label>
                        <div className="relative">
                      ...
                      {/* WhatsApp / Phone */}
                      <div className="space-y-2 text-left">
                        <label className="text-[10px] font-mono uppercase text-[#b9cac9] tracking-wider block">{locale === "es" ? "Número de WhatsApp" : "WhatsApp Number"}</label>
                        <div className="relative">
                      ...
                      {/* Telegram Username */}
                      <div className="space-y-2 text-left md:col-span-2">
                        <label className="text-[10px] font-mono uppercase text-[#b9cac9] tracking-wider block">{locale === "es" ? "Usuario de Telegram" : "Telegram Username"}</label>
                        <div className="relative">
                      ...
                      {/* City Dropdown */}
                      <div className="space-y-2 text-left md:col-span-2">
                        <label className="text-[10px] font-mono uppercase text-[#b9cac9] tracking-wider block">{locale === "es" ? "Ciudad" : "City"}</label>
                        <div className="relative">
                          ...
                          <select 
                            ...
                            suppressHydrationWarning
                          >
                            <option value="" disabled className="text-black bg-white">{locale === "es" ? "Selecciona una ciudad..." : "Select a city..."}</option>
                            {CITIES.map((c) => (
                              <option key={c.value} value={c.value} className="text-black bg-white">
                                {locale === "es" ? (c.labelEs || c.label) : c.label}
                              </option>
                            ))}
                          </select>
                        </div>
                      ...
                      <div className="space-y-3 text-left md:col-span-2 border-t border-white/5 pt-4">
                        <label className="text-[10px] font-mono uppercase text-[#b9cac9] tracking-wider block">{locale === "es" ? "Tus Canales de Contenido (enlaces para revisión)" : "Your Content Channels (links to review)"}</label>
                        ...
                        <div className="space-y-2">
                          <input 
                            ...
                            onChange={handleInputChange}
                            placeholder={locale === "es" ? "Enlace a perfil de Creador de Contenido (requerido)" : "Content Creator profile Link (required)"}
                          ...
                          <input 
                            ...
                            onChange={handleInputChange}
                            placeholder={locale === "es" ? "Enlace a Red Social (opcional)" : "Social Media Profile Link (optional)"}
                    ...
                    <div className="flex items-start gap-3 border-t border-white/5 pt-4">
                      ...
                      <label htmlFor="claimOffer" className="text-[11px] text-[#b9cac9] leading-relaxed text-left cursor-pointer">
                        {locale === "es" 
                          ? "Quiero reclamar la oferta del Pack IA 1 Año Gratis (Primer año gratuito del Asistente IA de Operaciones, y 69 €/mes después de que expire el año)."
                    ...
                    >
                      {formStep === "submitting" ? (
                        ...
                        <>
                          <span>{locale === "es" ? "Solicitar Acceso de Creador" : "Request Creator Access"}</span>
              ...
              >
                <DoubleBezelCard>
                  <div className="space-y-6 text-center max-w-md mx-auto py-4">
                    ...
                    <div className="space-y-3">
                      <h3 className="font-display text-2xl font-black text-white">{locale === "es" ? "Solicitud Recibida" : "Application Received"}</h3>
                      <p className="text-xs sm:text-sm text-[#b9cac9] leading-relaxed">
                        {locale === "es" ? "¡Te damos la bienvenida a SECCION, " : "Welcome to SECCION, "}<span className="text-[#00fbfb] font-bold">{formData.fullName || (locale === "es" ? "Creador" : "Creator")}</span>! {locale === "es" ? "El estado de tu perfil ahora es " : "Your profile status is now set to "}<span className="font-bold text-white uppercase font-mono bg-white/5 border border-white/10 px-2 py-0.5 rounded-md">{locale === "es" ? "EN REVISIÓN" : "UNDER REVIEW"}</span>.
                      </p>
                      <p className="text-xs text-[#b9cac9]/75 leading-relaxed">
                        {locale === "es" 
                          ? "Nuestro equipo de curaduría revisará personalmente los enlaces de tu perfil en un plazo de 48 horas. Una vez aprobado, enviaremos tu mensaje de bienvenida e invitación a tu estudio directamente a tu usuario de Telegram (" 
                          : "Our curation team will personally review your profile links within 48 hours. Once approved, we will trigger your welcome message and studio invite directly on your Telegram username ("}<span className="text-[#00fbfb]">{formData.telegram}</span>{locale === "es" ? ") y WhatsApp." : ") and WhatsApp."}
                      </p>
                    </div>
                    ...
                    >
                      <span>{locale === "es" ? "Explora tu Cabina de Estudio" : "Explore Your Studio Cockpit"}</span>
                    ...
                    >
                      {locale === "es" ? "Volver / Reiniciar" : "Go Back / Reset"}
                    </button>
                  </div>
                </DoubleBezelCard>
              </motion.div>
