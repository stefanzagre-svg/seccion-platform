...
const logPath = 'C:\\Users\\USER\\.gemini\\antigravity\\brain\\81787c0d-920d-4865-b133-c77db70489d5\\.system_generated\\tasks\\task-590.log';
...
if (fs.existsSync(logPath)) {
  ...
  console.log('Occurrences of VibeRadarPage in task-590.log:', matches.length);
  if (matches.length > 0) {
