...
if (fs.existsSync(filePath)) {
  ...
  for (const line of lines) {
    try {
      ...
      if (obj.step_index === 2517) {
        console.log('Step 2517 found!');
        console.log('Keys:', Object.keys(obj));
        console.log('Type:', obj.type);
        if (obj.content) {
          console.log('Content length:', obj.content.length);
          fs.writeFileSync('scripts/step_2517_content.txt', obj.content, 'utf8');
          console.log('Wrote content to scripts/step_2517_content.txt');
        }
      }
    } catch (e) {}
  }
