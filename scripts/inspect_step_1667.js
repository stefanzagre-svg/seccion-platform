...
if (fs.existsSync(filePath)) {
  ...
  for (const line of lines) {
    try {
      ...
      if (obj.step_index === 1665) {
        console.log('Step 1665 found!');
        console.log('Keys:', Object.keys(obj));
        console.log('Type:', obj.type);
        if (obj.content) {
          console.log('Content length:', obj.content.length);
          fs.writeFileSync('scripts/step_1665_content.txt', obj.content, 'utf8');
          console.log('Wrote content to scripts/step_1665_content.txt');
        }
      }
    } catch (e) {}
  }
